...
def get_message(birth_path_number)
	...
	case birth_path_number
		...
		when 5 
			puts "This is the freedom lover. The number five is an intellectual vibration. These are 'idea' people with a love of a variety and the ability to adapt to most situations. Ruled by Mercury." 
		when 6 
			puts "This is the peace lover. The nubmer six is a loving, stable, and harmonious vibration. Ruled by Venus."
		when 7 
...
puts "What is your birthdate? Please write it as MMDDYYYY"
birthdate = gets
